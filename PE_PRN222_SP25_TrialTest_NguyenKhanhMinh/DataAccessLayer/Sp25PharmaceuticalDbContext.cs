...
public partial class Sp25PharmaceuticalDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ManufacturerId).HasName("PK__Manufact__357E5CA1BEC62275");
        ...
        {
            entity.HasKey(e => e.MedicineId).HasName("PK__Medicine__4F2128F095D6AB70");
        ...
        {
            entity.HasKey(e => e.StoreAccountId).HasName("PK__StoreAcc__42D52A6AFD0B0168");

            entity.ToTable("StoreAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__StoreAcc__49A1474090C58D07").IsUnique();
