...
//        => optionsBuilder.UseSqlServer("Server=(local);Uid=sa;Pwd=123456789;Database=Lab1PharmaceuticalDB;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Manufacturer>(entity =>
        {
            entity.HasKey(e => e.ManufacturerId).HasName("PK__Manufact__357E5CA18B2DEC15");
        ...
        {
            entity.HasKey(e => e.MedicineId).HasName("PK__Medicine__4F2128F0E8B32EA5");
        ...
        {
            entity.HasKey(e => e.StoreAccountId).HasName("PK__StoreAcc__42D52A6A1675C0C7");

            entity.ToTable("StoreAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__StoreAcc__49A147404C4A24FB").IsUnique();
